document.addEventListener("DOMContentLoaded", function () {
  ...
  const userMap = {
      ...
      "AECKD1": { name: "Anh Em Cây Khế", examCode: "A472RQ" },
      "AECKD2": { name: "Anh Em Cây Khế", examCode: "A38TQI" },
      "AECKD3": { name: "Anh Em Cây Khế", examCode: "AX67AA" },
      "AECKD4": { name: "Anh Em Cây Khế", examCode: "AZA8OT" },
